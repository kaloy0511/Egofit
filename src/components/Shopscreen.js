...
const Shopscreen = () => {
  ...
  const allProducts = [
    ...
    },
    {
      id: 11,
      name: "Water Bottle",
      description: "Insulated water bottle to keep your drinks cold during workouts.",
      price: "₱350",
      category: "Accessories",
      image: "https://img4.dhresource.com/webp/m/0x0/f3/albu/jc/s/13/686f4192-b071-4afe-bb1c-24c2d5dfe6b9.jpg"
    },
    {
      id: 12,
      name: "Gym Towel",
      description: "Quick-dry microfiber towel perfect for gym sessions.",
      price: "₱250",
      category: "Accessories",
      image: "https://contents.mediadecathlon.com/p2866721/k$ba2693ee435775cada50c0e11c6000b4/small-cotton-fitness-towel-grey-domyos-8379828.jpg"
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <a href="#shop" onClick={() => scrollToSection('shop')} className="text-gray-700 hover:text-red-600 font-medium transition duration-200">SHOP</a>
      ...
      <main className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">Discover our complete collection of premium workout gear</p>
          </div>
          ...
          <div className="mb-8 flex justify-center">
            <div className="relative">
              <button
                ...
                className="bg-white border border-gray-300 rounded-lg px-6 py-3 text-gray-700 font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent flex items-center gap-2 min-w-[200px] justify-between"
              >
                ...
                <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-300 rounded-lg shadow-lg z-10">
                  {categories.map((category) => (
                    <button
                      ...
                      className={`block w-full text-left px-6 py-3 hover:bg-gray-50 first:rounded-t-lg last:rounded-b-lg ${
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <button 
                      ...
                      className="w-full bg-red-600 text-white py-2 font-medium hover:bg-red-700 transition duration-300 rounded"
                    >
                      ADD TO CART
                    </button>
                  </div>
